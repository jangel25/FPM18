...
namespace AppCocacolaNayMobiV2.Views.Planeaciones
{
	...
	public partial class ViEvaPlaneacionDetalle : ContentPage
	{
        private object FicLoParameter { get; set; }

		public ViEvaPlaneacionDetalle(object ficPaParameter)
		{
            InitializeComponent ();
            ...
            BindingContext = App.FicMetLocator.Eva_planeacionDetalle;
        }

   
        protected override void OnAppearing()
        {
            var viewModel = BindingContext as VmEvaPlaneacionDetalle;
